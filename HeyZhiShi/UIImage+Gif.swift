...
extension UIImage {
    ...
    public class func gifWithDataForImages(data: NSData) -> [UIImage]? {
        guard let source = CGImageSourceCreateWithData(data, nil) else {
            print("SwiftGif: Source for the image does not exist")
            return nil
        }
        return UIImage.animatedImageWithSourceForImages(source)
    }
    
    public class func gifWithNameForImages(name: String) -> [UIImage]? {
        guard let bundleURL = NSBundle.mainBundle().URLForResource(name, withExtension: "gif") else {
            print("SwiftGif: This image named \"\(name)\" does not exist")
            return nil
        }
        ...
        return gifWithDataForImages(imageData)
    }
    ...
    class func animatedImageWithSourceForImages(source: CGImageSource) -> [UIImage]? {
        let count = CGImageSourceGetCount(source)
        var images = [CGImageRef]()
        var delays = [Int]()
